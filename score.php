...
foreach ($arr as $question) {
    $userAnswer = $_POST['question_' . $question['q_id']];
...
$studentID = 1; // Assuming the student ID is 1
$sqlInsert = "INSERT INTO `student_score2` (`student_id`, `quiz2`) VALUES ('$studentID', '$score')";
...
<div class="score-board">
    ...
    <p>Maximum Possible Score: <?php echo count($arr); ?></p>
</div>
